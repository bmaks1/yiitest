...
class PositionController extends Controller
{
    ...
    public function actionDelete($id)
    {
        ...
        if($model)
        {
            if(!$model->workers)
                ...
                Yii::$app->session->setFlash('flsh_message',"You can't delete this position, because there are workers on this position");
        }
    ...
    {
        if (($model = Position::find()->where(['id'=>$id])->one()) !== null) {
            return $model;
        }
